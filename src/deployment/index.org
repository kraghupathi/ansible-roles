...
** Pull docker image
   ...
   on public [[https://hub.docker.com/][dockerhub]].  Ansible is installed on a ubuntu
   16.04.  This image is created by running these commands
   1. =docker build -t vlead/ansible .=
   2. Login to docker hub 
      =docker login --username=vlead=
   3. =docker push vlead/ansible=
